local ITEM_ID_OFFSET = 264000
local LOCATION_ID_OFFSET = 264000
...
local DSTAP_ITEMS = {
    ...
    {431, "Brightshade Helm",            "lunarplanthat",                             { "nounlock", "useful" },                    { "MAGIC", "ARMOUR" } },
...
local DSTAP_LOCATIONS = {
    ...
    {280,   "Celestial Revenant",       "alterguardian_phase1_lunarrift",          { "boss", "raidboss", "ocean" } },
    {281,   "Enlightened W.A.R.B.O.T",  "wagboss_robot",            { "boss", "raidboss", "ocean" } },
    {282,   "Celestial Scion",          "alterguardian_phase4_lunarrift",          { "boss", "raidboss", "ocean" } },
    ...
    {509,   "Science (Jet Feather)",            "feather_crow",             { "research", "science", "tier_2", "autumn", "winter", "day", "dusk" } },
    {510,   "Science (Saffron Feather)",        "feather_canary",           { "research", "science", "tier_2", "day", "dusk", "seasons_passed_1" } },
...
--
BOSS_DAMAGE_ALIASES = {
    eyeofterror_mini = "eyeofterror",
    mossling = "moose",
    alterguardian_phase1 = "alterguardian_phase3",
    alterguardian_phase2 = "alterguardian_phase3",
    beeguard = "beequeen",
    lavae = "dragonfly",
    crabking_claw = "crabking_claw",
...
-- Aliases
local DSTAP_LOCATION_ALIASES = {
    bishop_nightmare = "bishop",
    knight_nightmare = "knight",
    rook_nightmare = "rook",
    koalefant_winter = "koalefant_summer",
    pigguard = "pigman",
    toadstool_dark = "toadstool",
    leif_sparse = "leif",
    crawlingnightmare = "crawlinghorror",
    nightmarebeak = "terrorbeak",
    oceanhorror = "terrorbeak",
    mermguard = "merm",
    babybeefalo = "beefalo",
    smallbird = "tallbird",
    teenbird = "tallbird",
    ...
    friendlyfruitfly = "fruitflyfruit",
    gingerbreadwarg = "warg",
    claywarg = "warg",
    clayhound = "hound",
    gnarwail_attack_horn = "gnarwail",
}

-- Scrapbook aliases (Location local id/prefab -> scrapbook key)
local LOCATION_SCRAPBOOK_ALIASES = {
    -- Misc (1-100)
    [1] = "archive_lockbox",        -- Distilled Knowledge (Yellow)
    [2] = "archive_lockbox",        -- Distilled Knowledge (Blue)
    [3] = "archive_lockbox",        -- Distilled Knowledge (Red)
    [4] = "moonstorm_static_item",  -- Wagstaff during Moonstorm
    [5] = "monkeyqueen",            -- Queen of Moon Quay
    [6] = "pigking",                -- Pig King
    [7] = "chester",                -- Chester
    [8] = "hutch",                  -- Hutch
    [9] = "stagehand",              -- Stagehand
    [10] = "pirate_stash",          -- Pirate Stash
    [11] = "moonbase",              -- Moon Stone Event
    [12] = "oasislake",             -- Oasis
    [13] = "deciduoustree_tall",    -- Poison Birchnut Tree
    [14] = "storage_robot",         -- W.O.B.O.T.
    [15] = "friendlyfruitfly",      -- Friendly Fruit Fly
    ...
    [621] = "researchlab3", -- Magic (Sanity)

    -- Hermit Crab (851-900)
    [851] = "hermitcrab", -- Bottle Exchange (1)
    [852] = "hermitcrab", -- Bottle Exchange (2)
    [853] = "hermitcrab", -- Bottle Exchange (3)
    [854] = "hermitcrab", -- Bottle Exchange (4)
    [855] = "hermitcrab", -- Bottle Exchange (5)
    [856] = "hermitcrab", -- Bottle Exchange (6)
    [857] = "hermitcrab", -- Bottle Exchange (7)
    [858] = "hermitcrab", -- Bottle Exchange (8)
    [859] = "hermitcrab", -- Bottle Exchange (9)
    [860] = "hermitcrab", -- Bottle Exchange (10)
}

-- Hint when examined
_hermit_crab_check_ids = {851, 852, 853, 854, 855, 856, 857, 858, 859, 860}
local LOCATION_SCOUTS = {
    trinket_15 = "shadow_bishop",
    trinket_16 = "shadow_bishop",
    chesspiece_bishop_sketch = "shadow_bishop",
    sculpture_bishophead = "shadow_bishop",
    sculpture_bishopbody = "shadow_bishop",
    trinket_30 = "shadow_knight",
    trinket_31 = "shadow_knight",
    chesspiece_knight_sketch = "shadow_knight",
    sculpture_knighthead = "shadow_knight",
    sculpture_knightbody = "shadow_knight",
    trinket_28 = "shadow_rook",
    trinket_29 = "shadow_rook",
    chesspiece_rook_sketch = "shadow_rook",
    sculpture_rooknose = "shadow_rook",
    sculpture_rookbody = "shadow_rook",
    moon_altar_link = "alterguardian_phase3",
    moon_altar = "alterguardian_phase3",
    moon_altar_astral = "alterguardian_phase3",
    moon_altar_cosmic = "alterguardian_phase3",
    beequeenhivegrown = "beequeen",
    klaus_sack = "klaus",
    icefishing_hole = "sharkboi",
    shadowheart = "stalker_atrium",
    terrarium = {"eyeofterror", "twinofterror1", "twinofterror2"},
    toadstool_cap = "toadstool",
    hermit_pearl = "crabking",
    wagstaff_npc = 4,
    monkeyqueen = 5,
    pigking = 6,
    stagehand = 9,
    ...
    deciduoustree = 13,
    storage_robot = 14,
    messagebottle = _hermit_crab_check_ids,
    messagebottleempty = _hermit_crab_check_ids,
    hermitcrab = _hermit_crab_check_ids,
    asparagus_seeds = {"asparagus", "asparagus_oversized"},      
    garlic_seeds = {"garlic", "garlic_oversized"},         
    pumpkin_seeds = {"pumpkin", "pumpkin_oversized"},        
    corn_seeds = {"corn", "corn_oversized"},           
    onion_seeds = {"onion", "onion_oversized"},          
    potato_seeds = {"potato", "potato_oversized"},         
    dragonfruit_seeds = {"dragonfruit", "dragonfruit_oversized"},    
    pomegranate_seeds = {"pomegranate", "pomegranate_oversized"},    
    eggplant_seeds = {"eggplant", "eggplant_oversized"},       
    tomato_seeds = {"tomato", "tomato_oversized"},         
    watermelon_seeds = {"watermelon", "watermelon_oversized"},     
    pepper_seeds = {"pepper", "pepper_oversized"},         
    durian_seeds = {"durian", "durian_oversized"},         
    carrot_seeds = {"carrot", "carrot_oversized"},         
}

local CHARACTER_PREFAB_TO_PRETTYNAME = {
    wilson = "Wilson",
    willow = "Willow",
    wendy = "Wendy",
    wolfgang = "Wolfgang",
...
GLOBAL.ArchipelagoDST.RAW = {
    ITEM_ID_OFFSET = ITEM_ID_OFFSET,
    LOCATION_ID_OFFSET = LOCATION_ID_OFFSET,
    ITEMS = DSTAP_ITEMS,
    LOCATIONS = DSTAP_LOCATIONS,
    LOCATION_ALIASES = DSTAP_LOCATION_ALIASES,
    LOCATION_SCRAPBOOK_ALIASES = LOCATION_SCRAPBOOK_ALIASES,
    LOCATION_SCOUTS = LOCATION_SCOUTS,
    BUNDLE_DEFS = BUNDLE_DEFS,
    BOSS_DAMAGE_ALIASES = BOSS_DAMAGE_ALIASES,
    CHARACTER_PREFAB_TO_PRETTYNAME = CHARACTER_PREFAB_TO_PRETTYNAME,
    ITEM_LOCKS_V1_0_2 = ITEM_LOCKS_V1_0_2,
}